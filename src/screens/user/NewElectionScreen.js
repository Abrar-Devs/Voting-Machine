  ...
  return (
    <View>
      <View>
        ...
        >
          <PickDateTime label='Start time' date={startDate} setDate={setStartDate} />
          <PickDateTime label='Finish time' date={endDate} setDate={setEndDate} />
...
const PickDateTime = ({ label, date, setDate }) => {
  ...
  return (
    <View style={globalStyles.cardView}>
      ...
      >
        <Text style={[globalStyles.text(), globalStyles.txtColor('white')]}>Select {label}</Text>
      </TouchableOpacity>
      <DatePicker
        modal
        open={open}
